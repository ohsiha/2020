...
<p>
  Harjoitustyön pohjana saa hyödyntää aikaisemmin esimerkiksi harrastusprojektina toteutettua sovellusta siinä tapauksessa, että sitä ei aikaisemmin ole miltään osin käytetty osana mitään opintosuoritusta.
...
<!--   Ohjeita kehitysympäristön perustamiseen löytyy esimerkiksi <a href="https://iislab.ee.tut.fi/piiri/ohjelmallinen-sis%C3%A4ll%C3%B6nhallinta-2015/wiki/harjoitusty%C3%B6#">Ohjelmallinen sisällönhallinta 2015 -ryhmästä</a>, <a href="https://hlab.ee.tut.fi/piiri/groups/ohjelmallinen-sisallonhallinta-2014/story/kehitysympariston-perustaminen-muutama-sana-lampist">CodeIgniter-ohjeesta</a> (Vaahtolammi 2014) ja <a href="https://iislab.ee.tut.fi/piiri/system/files/Vierailuluento-10022015.pdf">Docker- ja Ruby on Rails -ohjeesta</a> <strong>PDF</strong> (Hakulinen 2015).  -->
</p>
...
<h3>Harjoitustyöpisteet ja arvosana</h3>
<p>
...
<!--   <a href="https://iislab.ee.tut.fi/piiri/groups/ohjelmallinen-sis%C3%A4ll%C3%B6nhallinta-2016#overlay=node/add/article%3Fog_group_ref%3D8061%26destination%3Dnode/8061">julkaise se TTY-Piirin Juttuna</a>.
  Huomioi <a href="https://iislab.ee.tut.fi/piiri/hypermedian-ohjelmointi-2013/blog/tty-piirin-juttujen-n%C3%A4kyvyydest%C3%A4">Piiriin kirjoitettujen viestien näkyvyys</a>.
 --></p>
<p id="teknologiatagi">
...
<blockquote>
  ...
  <!-- <p>Linkki profiiliini TTY-Piirissä: <a href="http://hlab.ee.tut.fi/piiri/user/james-station">http://hlab.ee.tut.fi/piiri/user/james-station</a></p> -->
  <p>Korvaan tenttisuorituksen luentopäiväkirjalla. Osoite luentopäiväkirjaani: <a href="http://blog.fi/jamesstation/ohsiha2017">http://blog.fi/jamesstation/ohsiha2017</a></p>
</blockquote>
<p>
